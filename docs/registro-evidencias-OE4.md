...
| Artefacto de evidencia | docs/RAT.md (o tabla del RAT); referencia cruzada con inventario-datos.md. |
...
| Artefacto de evidencia | docs/DRP.md (tabla de requisitos de privacidad). |
...
| Artefacto de evidencia | docs/MRP.md (matriz de 12 riesgos). |
...
| Artefacto de evidencia | docs/inventario-datos.md; schema.prisma; capturas ANA-01_1, ANA-01_2, ANA-01_3. |
...
| Artefacto de evidencia | schema.prisma (modelo Consulta); inventario-datos.md (columna clasificación); captura ANA-02_1. |
...
| Artefacto de evidencia | docs/informe-necesidad-EIPD.md (tabla de criterios de alto riesgo + conclusión). |
...
| Artefacto de evidencia | Captura DIS-01/01-arquitectura-privacidad.png (diagrama de arquitectura). |
...
| Artefacto de evidencia | Captura DIS-02/01-diseno-minimizacion.png (diagrama del filtro de minimización). |
...
| Artefacto de evidencia | Captura DIS-03/01-wireframe-consentimiento.png. |
...
| Artefacto de evidencia | Captura DIS-04/01-wireframe-arco.png. |
...
| Artefacto de evidencia | Capturas DIS-05/: 01-aviso-privacidad.png (página /privacidad sin login), 02-enlace-transparencia.png (enlace visible en login/pie). |
...
| Artefacto de evidencia | crypto.js; backend/certs/; docker-compose.yml (SSL); capturas DES-01/: 01-bd-cifrado-ilegible.png, 02-api-descifrado-legible.png, 03-tamper-descifrado-falla.png, 04-https-ssl-transito.png (handshake TLSv1.3 navegador↔API + pg_stat_ssl ssl=t backend↔BD). |
...
| Artefacto de evidencia | matriz-acceso-roles.md; capturas DES-02/: 01-usuarios-hash-bcrypt.png, 02-04-consultas-403-y-200.png, 05-403-usuarios.png, 06-matriz-acceso-roles.png. |
...
| Artefacto de evidencia | arcoController.js; validarTokenArco.js; capturas DES-03/: 01-arco-acceso.png, 02-arco-rectificacion.png, 03-arco-portabilidad.png, 04-arco-oposicion.png, 05-arco-eliminacion-conserva-clinica.png. |
...
| Artefacto de evidencia | consentimientoController.js; auditoria.js; capturas DES-04/: 01-422-sin-consentimiento.png, 02-auditoria-metadatos.png (tabla de auditoría con metadatos, sin contenido clínico), 03-auditoria-403.png. |
...
| Artefacto de evidencia | seguridad.js; SeguridadView.jsx; captura DYM-01/01-eventos-seguridad.png (panel con los 4 tipos de evento registrados). |
...
| Artefacto de evidencia | politica-conservacion.md; conservacion.js; capturas DYM-02/: 01-conservacion-anonimizacion.png, 02-registro-anonimizado.png (registro sin vínculo a persona). |
...
| Artefacto de evidencia | mantenimiento-privacidad.js; capturas DYM-03/: 01-panel-estado-ok.png (5 medidas OK), 02-deteccion-fallo.png (detección tras degradación deliberada). |
