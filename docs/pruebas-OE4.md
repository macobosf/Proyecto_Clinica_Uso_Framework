...
> Este documento no introduce controles nuevos ni código nuevo: consolida, en formato de evidencia trazable, pruebas que ya se ejecutaron y verificaron durante el desarrollo del piloto (ver `docs/registro-evidencias-OE4.md` para las fichas completas de cada control).
